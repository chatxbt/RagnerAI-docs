...
In software engineering, composition is a powerful concept. It allows for building complex systems from simple, interchangeable parts. Think Legos, Docker containers. in Ragner we apply this concept to turn protocols (APIs) into partners for human and AI agents collaboration.
...
<CardGroup cols={2}>
  <Card title="View More Usecases" href="usecases">
    Explore more real-worldusecases and how Ragner can help you
  </Card>
  <Card title="Beyond Just Composable API Agents" href="introduction">
    Learn more about how to use Ragner for other communication interfaces
  </Card>
</CardGroup>
